    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-10 border-b bg-background/80 backdrop-blur-sm">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
          ...
          <h1 className="flex-1 text-center text-xl font-bold">Blog</h1>
        </div>
      </header>
      <main className="container mx-auto max-w-4xl px-4 py-8 md:px-6 md:py-12">
        <div className="flex min-h-[40vh] flex-col items-center justify-center space-y-4 rounded-lg border bg-card p-8 text-center">
            <h2 className="text-3xl font-bold tracking-tight">Our Blog is Coming Soon</h2>
            <p className="text-lg text-muted-foreground">
              Stay tuned for articles, tutorials, and updates from the CODEEX AI team.
            </p>
            <Link href="/">
